...
$(function () {
  ...
  var arrow = '<svg class="icon" fill="currentColor" viewBox="0 0 10.5 18.1"><path d="M1.4,18.1L0,16.7l7.6-7.6L0,1.5L1.4,0l9,9.1C10.4,9.1,1.3,18.1,1.4,18.1z"></path></svg>';
  $('.top-slider').owlCarousel({
    ...
    nav: true,
    navText: [arrow, arrow],
    autoplayTimeout: $('.top-slider').attr('data-autoplay-timeout') * 1000,
    responsive: {
      0: {
        items: 1
      }
